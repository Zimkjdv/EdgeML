...
- **v0.7.3 (in progress):** bounded retries with configurable attempt limits, exponential backoff, and dead-letter routing are implemented. Graceful worker shutdown, worker capacity controls, queue-depth dashboards, and operational controls remain planned follow-up work.
