...
- **Reliability backlog:** add Redis persistence, atomic multi-worker recovery, JSON payload limits, runtime integration tests, optional API-token authentication, and database-backed repositories before multi-user production deployment.
