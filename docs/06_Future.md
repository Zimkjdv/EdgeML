...
- **v0.7.3 (in progress):** bounded retries with configurable attempt limits, exponential backoff, dead-letter routing, and graceful worker shutdown are implemented. Worker capacity controls, queue-depth dashboards, and operational controls remain planned follow-up work.
