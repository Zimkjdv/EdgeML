...
| v0.7.3 (in progress) | Bounded retries with configurable attempts and exponential backoff; dead-letter handling, worker capacity controls, queue operations, and runtime integration tests remain |
