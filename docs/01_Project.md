...
| v0.7.3 (in progress) | Bounded retries and dead-letter routing with configurable attempts and exponential backoff; worker capacity controls, queue operations, and runtime integration tests remain |
