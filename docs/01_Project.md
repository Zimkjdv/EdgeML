...
| v0.7.1 (in progress) | Structured logs, request tracing, metrics, and health/readiness checks |
| v0.7.2 (planned) | Queue-backed training workers for long-running concurrent training |
